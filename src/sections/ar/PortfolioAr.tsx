...
const projects = [
  ...
  {
    title: "وحدة ديكور ذهبية بخطوط طولية",
    category: "وحدات ديكورية",
    img: "/73.webp",
    desc: "وحدة عرض مصممة حسب الطلب، تجمع بين الرفوف المفتوحة والتخزين المخفي لإطلالة داخلية راقية.",
  },
  ...
  {
    title: "غرفة نوم كلاسيكية مزدوجة",
    category: "غرف نوم",
    img: "/75.webp",
    desc: "غرفة نوم كلاسيكية بتفاصيل متقنة تضيف للمساحة راحة وأناقة بطابع راقٍ.",
  },
  {
