            ...
            {locations.map((l, i) => {
              ...
              return (
                <button
                  ...
                  className={`relative flex items-center gap-4 px-6 py-5 lg:py-7 text-left transition-colors duration-300 cursor-pointer shrink-0 lg:shrink group ${
          ...
          <div className="lg:order-2 lg:col-span-5 relative overflow-hidden h-85 lg:h-auto bg-background">
            <AnimatePresence mode="wait">
              <motion.iframe
                key={loc.id + "-map"}
                src={loc.mapSrc}
                title={`${loc.city} studio location`}
                width="100%"
                height="100%"
